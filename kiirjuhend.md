...
![](.gitbook/assets/E-arhiiviteatis-Halda-töötajaid.png)
...
<pre><code><strong>curl --location --request POST '{{apiBaseUrl}}/api/ska/file/create?token=71e0d98f1ab52c225d655359190b684' \
</strong>--data-raw '{
